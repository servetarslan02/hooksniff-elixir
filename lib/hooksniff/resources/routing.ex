defmodule HookSniff.Routing do
  ...
  def get(client, endpoint_id), do: Client.request(:get, "/v1/routing/#{endpoint_id}/routing", nil, client)

  @doc "Update routing"
  @spec update(HookSniff.t(), String.t(), map()) :: {:ok, map()} | {:error, term()}
  def update(client, endpoint_id, params), do: Client.request(:put, "/v1/routing/#{endpoint_id}/routing", params, client)

  @doc "Get routing health"
  @spec get_health(HookSniff.t(), String.t()) :: {:ok, map()} | {:error, term()}
  def get_health(client, endpoint_id), do: Client.request(:get, "/v1/routing/#{endpoint_id}/health", nil, client)
end
