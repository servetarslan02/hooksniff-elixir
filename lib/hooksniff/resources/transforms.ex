defmodule HookSniff.Transforms do
  ...
  def list(client), do: Client.request(:get, "/api/v1/transforms", nil, client)

  @doc "Create a transform"
  @spec create(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def create(client, params), do: Client.request(:post, "/api/v1/transforms", params, client)

  @doc "Update a transform"
  @spec update(HookSniff.t(), String.t(), map()) :: {:ok, map()} | {:error, term()}
  def update(client, id, params), do: Client.request(:put, "/api/v1/transforms/#{id}", params, client)

  @doc "Delete a transform"
  @spec delete(HookSniff.t(), String.t()) :: {:ok, map()} | {:error, term()}
  def delete(client, id), do: Client.request(:delete, "/api/v1/transforms/#{id}", nil, client)

  @doc "Test a transform"
  @spec test_transform(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def test_transform(client, params), do: Client.request(:post, "/api/v1/transforms/test", params, client)
end
