defmodule HookSniff.MessageAttempts do
  ...
  def list_by_endpoint(client, endpoint_id, opts \\ []) do
    path = build_query("/v1/attempt/endpoint/#{endpoint_id}", opts)
  ...
  def list_by_msg(client, msg_id, opts \\ []) do
    path = build_query("/v1/attempt/msg/#{msg_id}", opts)
    Client.request(:get, path, nil, client)
  end

  @doc "Get an attempt"
  @spec get(HookSniff.t(), String.t(), String.t()) :: {:ok, map()} | {:error, term()}
  def get(client, msg_id, attempt_id), do: Client.request(:get, "/v1/msg/#{msg_id}/attempt/#{attempt_id}", nil, client)

  @doc "Resend to endpoint"
  @spec resend(HookSniff.t(), String.t(), String.t()) :: {:ok, map()} | {:error, term()}
  def resend(client, msg_id, endpoint_id), do: Client.request(:post, "/v1/msg/#{msg_id}/endpoint/#{endpoint_id}/resend", nil, client)
