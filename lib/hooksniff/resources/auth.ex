defmodule HookSniff.Auth do
  ...
  def logout(client), do: Client.request(:post, "/v1/auth/logout", nil, client)

  @doc "Get current user"
  @spec me(HookSniff.t()) :: {:ok, map()} | {:error, term()}
  def me(client), do: Client.request(:get, "/v1/auth/me", nil, client)

  @doc "Update profile"
  @spec update_profile(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def update_profile(client, params), do: Client.request(:put, "/v1/auth/profile", params, client)

  @doc "Change password"
  @spec change_password(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def change_password(client, params), do: Client.request(:put, "/v1/auth/password", params, client)
  ...
  def reset_password(client, params), do: Client.request(:post, "/v1/auth/reset-password", params, client)

  @doc "Verify email"
  @spec verify_email(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def verify_email(client, params), do: Client.request(:post, "/v1/auth/verify-email", params, client)

  @doc "Resend verification email"
  @spec resend_verification(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def resend_verification(client, params), do: Client.request(:post, "/v1/auth/resend-verification", params, client)

  @doc "Enable two-factor authentication"
  @spec enable_2fa(HookSniff.t()) :: {:ok, map()} | {:error, term()}
  def enable_2fa(client), do: Client.request(:post, "/v1/auth/2fa/enable", nil, client)

  @doc "Confirm 2FA setup"
  @spec confirm_2fa(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def confirm_2fa(client, params), do: Client.request(:post, "/v1/auth/2fa/confirm", params, client)

  @doc "Disable 2FA"
  @spec disable_2fa(HookSniff.t(), map()) :: {:ok, map()} | {:error, term()}
  def disable_2fa(client, params), do: Client.request(:post, "/v1/auth/2fa/disable", params, client)

  @doc "Get 2FA status"
  @spec get_2fa_status(HookSniff.t()) :: {:ok, map()} | {:error, term()}
  def get_2fa_status(client), do: Client.request(:get, "/v1/auth/2fa/status", nil, client)
  ...
  def delete_account(client, params), do: Client.request(:delete, "/v1/auth/account", params, client)
end
