defmodule HookSniff.Endpoints do
  ...
  def rotate_secret(client, id), do: Client.request(:post, "/v1/endpoints/#{id}/secret/rotate", %{}, client)

  @doc "Get endpoint headers"
  @spec get_headers(HookSniff.t(), String.t()) :: {:ok, map()} | {:error, term()}
  def get_headers(client, id), do: Client.request(:get, "/v1/endpoints/#{id}/headers", nil, client)

  @doc "Update endpoint headers"
  @spec update_headers(HookSniff.t(), String.t(), map()) :: {:ok, map()} | {:error, term()}
  def update_headers(client, id, params), do: Client.request(:put, "/v1/endpoints/#{id}/headers", params, client)
